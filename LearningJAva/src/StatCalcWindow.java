...
public class StatCalcWindow {
  ...
  public void buildWindow() {
    ...
    try {
      ...
      levelField = new JFormattedTextField();
      ...
      textField_IV_HP.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_EV_HP.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_IV_Att.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_EV_Att.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_IV_Def.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_EV_Def.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_IV_SpAtt.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_EV_SpAtt.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_IV_SpDef.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_EV_SpDef.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_IV_SpD.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      textField_EV_SpD.addKeyListener(new KeyAdapter() {
        public void keyTyped(KeyEvent e) {
          char c = e.getKeyChar();
          if (((c < '0') || (c > '9')) && (c != KeyEvent.VK_BACK_SPACE)
              && (c != KeyEvent.VK_ENTER)) {
      ...
      btnCalculate.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent arg0) {
          getWindowData(natureComboBox, rdbtnShiny, statCalcFrame);
        }
      });
      statCalcFrame.getRootPane().setDefaultButton(btnCalculate);
  ...
  public void getWindowData(JComboBox<?> natureComboBox,
      AbstractButton rdbtnShiny, JFrame frame) {
    try {
      ...
      PokemonStatsDisplayWindow pokeWin = new PokemonStatsDisplayWindow();
      pokeWin.buildStatsDisplayWindow(poke);
    } catch (Exception e) {
      ErrorWindow error = new ErrorWindow();
      error.buildWindow(e);
      frame.dispose();
